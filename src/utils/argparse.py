...
def parse_args():
    ...
    parser.add_argument("--hidden-dim", type=int, default=128, help="Number of neurons in the hidden layers of Dueling DQN")
    parser.add_argument("--batch-size", type=int, default=64, help="Batch size for training the DQN agent")
    parser.add_argument("--target-update", type=int, default=1000, help="Number of steps between target network synchronizations")
    ...
    parser.add_argument("--grid-type", type=str, choices=["fast", "standard", "comprehensive", "custom"], default="standard", help="Type of grid search configuration (fast, standard, comprehensive, custom)")
    parser.add_argument("--custom-grid", type=str, default=None, help="JSON string representing custom grid search (e.g. '{\"alpha\": [1e-3, 3e-4], \"gamma\": [0.99]}')")
